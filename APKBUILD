...
pkgver=5
pkgrel=0
pkgdesc="Firmware for Xiaomi Redmi 4 Prime"
url="https://github.com/Kiciuk/proprietary_firmware_markw"
arch="aarch64"
license="proprietary"
options="!check !strip !archcheck"
_commit="bc001cbb255a0ded2b58af07b93f712cd9322483"
source="https://github.com/Kiciuk/proprietary_firmware_markw/archive/$_commit.zip"
builddir="$srcdir/proprietary_firmware_markw-$_commit"
